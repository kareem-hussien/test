"""
Flask application factory update for Travian Whispers.
This is an updated version of the application factory that includes maintenance mode support.
"""
import os
import json
...
def configure_app(app, config_object=None):
    ...
    app.config.setdefault('MAINTENANCE_MESSAGE', 
        'We are currently performing scheduled maintenance. Please check back later.')
    app.config.setdefault('MAINTENANCE_UNTIL', None)
